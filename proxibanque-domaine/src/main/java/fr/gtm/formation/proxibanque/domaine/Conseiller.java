...
/**
 * Class Conseiller belongs to the layer domain This class allows
...
@NamedQueries(
		{
			...
			, @NamedQuery(name = "Conseiller.findByLogin", query = "SELECT c FROM Conseiller c WHERE c.login = :login")
		})
