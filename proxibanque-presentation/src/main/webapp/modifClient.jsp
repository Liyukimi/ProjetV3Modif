				...
				<form class="form" method="post" action="ModifClient">
					<fieldset>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" placeholder="${client.nom}" name="nom"  title="Maximum 20 caractères non accentués" pattern="[a-zA-Z][a-zA-Z-]*">
						</div>
						<div class="form-group">
							<label  for="prenom">Prénom :</label>
							<input type="text" class="form-control" placeholder="${client.prenom}" name="prenom" title="Maximum 20 caractères non accentués" pattern="[a-zA-Z][a-zA-Z-]*">
						</div>
						<div class="form-group">
